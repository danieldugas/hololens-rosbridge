...
public class CameraSubscriber : RosComponent
{
    ...
    public String ImageTopic = "/pepper_robot/camera/front/image_raw";
    public double SubscriptionRate = 10;

    // Use this for initialization
    void Start()
    {
        Subscribe("CameraSubscriber", ImageTopic, SubscriptionRate, out sub);
